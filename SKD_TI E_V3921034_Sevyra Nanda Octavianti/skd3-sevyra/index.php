...
<body>
    ...
    <div class="container" id="container">
        <div class="form-container sign-up-container">
                ...
                if (isset($_POST['enkripsi'])) { //mengeksekusi enkripsi 
                    ...
                    { //menampung data yang telah di input
                        if (ctype_alpha($char)) { //cek alphabet atau tidak
                            ...
                            $mod = fmod($ch + $key - $nilai, 26); //perhitungan modulus dengan  jumlah alphabet=26
                    ...
                    <div class="box-footer">
                        <table class="table table-stripped">
                            <tr>
                                ...
                                <td><input class="btn btn-danger" type="submit" name="enkripsi" value="Enkripsi"
                                        style="width: 100%"></td>
                                <td><input class="btn btn-success" type="submit" name="dekripsi" value="Dekripsi"
                                        style="width: 100%"></td>
                            </tr>
                        </table>
                    </div>
            ...
            <div class="card-header text-center bg-danger bg-gradient">
                <h4><b>OUTPUT</b></h4>
            </div>
            <div class="card-body">
                <table>
        ...
        <!-- membuat tampilan overlay pada container -->
        <div class="overlay-container">
            <div class="overlay">
                <div class="overlay-panel overlay-left">
                    <h1>Caesar Cipher Program</h1>
                    <p>Untuk mengetahui bagaimana cara kerjanya, yuk inputkan dulu dan amati!
                    </p>
                    <button class="ghost" id="signIn">Back</button>
                </div>
                <div class="overlay-panel overlay-right">
                    <h1>Hello, Friend!</h1>
                    <p>Welcome in Tugas SKD modul 3 by Sevyra Nanda - V3921034 </p>
                    <button class="ghost" id="signUp">Mari Mencoba Program Caesar Cipher</button>
                </div>
            </div>
        </div>
    </div>
    ...
    // agar button ketika di klik melakukan overlay atau pergeseran
